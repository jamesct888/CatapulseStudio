...
<head>
    ...
    <style>
      body { background-color: ${theme.mode === 'type2' ? '#ffe2e8' : '#fafafa'}; color: #0b3239; }
...
<body>
    ...
    <script type="text/babel">
        ...
        const App = () => {
            ...
            if (isCompleted) {
                return (
                    <div className={\`min-h-screen \${isType2 ? 'bg-[#ffe2e8]' : 'bg-[#fafafa]'}\`}>
            ...
            return (
                <div className={\`min-h-screen \${isType2 ? 'bg-[#ffe2e8]' : 'bg-[#fafafa]'}\`}>
                    ...
                    <div className="max-w-5xl mx-auto py-12 px-6">
                        ...
                        <div className={\`bg-white shadow-card rounded-2xl border overflow-hidden min-h-[600px] relative \${isType2 ? 'border-[#ffe2e8]' : 'border-gray-100'}\`}>
