...
export const ModePreview: React.FC<ModePreviewProps> = ({ processDef, formData, setFormData, visualTheme, personaPrompt, setPersonaPrompt }) => {
  ...
  // --- Theme Classes ---
  // Type 2 uses Gray Background (#e0e0e0) and Red Headers (#e61126)
  const containerBg = isType2 ? 'bg-white border-[#e0e0e0]' : 'bg-white border-gray-100';
  ...
  const pageBg = isType2 ? 'bg-[#e0e0e0]' : 'bg-sw-lighterGray';
